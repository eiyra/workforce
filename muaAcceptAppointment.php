<?php
	...
	else
	{
		...
		{
			$app_id=$_GET['app_id'];
			$query1=mysqli_query($con,"UPDATE appointment set app_status='CONFIRMED' where app_id='$app_id'");
			if($query1)
			{
				...
				$objResult = mysqli_fetch_array($result);
					...
					if($objResult == true)
					{
						...
						$message  = "<table width='50%' align='center'><tr><td>
											...
											<br>
											Congrats! Your appointment with ".$objResultSupp["mua_name"]." has been approved.
											<br><br><br>
