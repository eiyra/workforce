...
<br><br>
					...
					<h3>Amount of Total Charge Against Months</h3>
					<br>
					...
					<?php
					  ...
					  for ($i = 0; $i < sizeof($month); $i++)
					    ...
					    where mua_ic = '".$_SESSION['mua_ic']."'
					      AND EXTRACT(month from app_date) = '$month[$i]' AND app_status = 'CONFIRMED' ";
					...
					Morris.Bar({
					  ...
					  data: [
					   ...
					   {x: 'Jan', y: <?php echo $dataPoints[0];?>},
					    {x: 'Feb', y: <?php echo $dataPoints[1];?>},
					    {x: 'Mar', y: <?php echo $dataPoints[2];?>},
					    {x: 'Apr', y: <?php echo $dataPoints[3];?>},
					    {x: 'May', y: <?php echo $dataPoints[4];?>},
					    {x: 'Jun', y: <?php echo $dataPoints[5];?>},
					    {x: 'July', y: <?php echo $dataPoints[6];?>},
					    {x: 'Aug', y: <?php echo $dataPoints[7];?>},
					    {x: 'Sep', y: <?php echo $dataPoints[8];?>},
					  {x: 'Oct', y: <?php echo $dataPoints[9];?>},
					  {x: 'Nov', y: <?php echo $dataPoints[10];?>},
					  {x: 'Dec', y: <?php echo $dataPoints[11];?> }
					  ],
					  xkey: 'x',
					  ykeys: ['y'],
					  labels: ['Total sales'],
					...
					<h3>Percentage of Appointments</h3>
