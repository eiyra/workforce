...
<li><a href="customerChangePassword.php"><i class="fa fa-key"></i>Change Password</a></li>
			...
			<div class="grid-form1">
				...
				<form class="form-horizontal" method="POST" action="customerUploadFile.php" enctype="multipart/form-data">
	<div class="col-md-6">
					<div class="form-group">
					<label for="inputEmail3" class="col-sm-4 control-label hor-form">Name:</label>
					<div class="col-sm-8">
						<input type="text" class="form-control" id="inputEmail3" name="fullname" value="<?php echo $objResult['customer_name']; ?>">
					</div>
					</div>
					...
					<div class="col-sm-8">
						<input type="email" class="form-control" id="inputEmail3" name="email" value="<?php echo $objResult['customer_email']; ?>">
					</div>
					</div>
					...
					<div class="col-sm-8">
						<input type="number" class="form-control" id="inputEmail3" name="phoneno" value="<?php echo $objResult['customer_phone_no']; ?>">
					</div>
					</div>
					...
					<div class="col-sm-8">
						<input type="text" class="form-control" id="inputEmail3" name="address" value="<?php echo $objResult['customer_address']; ?>">
					</div>
					</div>
