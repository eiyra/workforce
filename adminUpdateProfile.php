...
<li><a href="adminChangePassword.php"><i class="fa fa-key"></i>Change Password</a></li>
			...
			<div class="grid-form1">
				...
				<form class="form-horizontal" method="POST" action="adminUploadFile.php" enctype="multipart/form-data">
	<div class="col-md-6">
					<div class="form-group">
					<label for="inputEmail3" class="col-sm-4 control-label hor-form">Name:</label>
					<div class="col-sm-8">
						<input type="text" class="form-control" id="inputEmail3" name="fullname" value="<?php echo $objResult['admin_name']; ?>">
					</div>
					</div>
					...
					<div class="col-sm-8">
						<input type="email" class="form-control" id="inputEmail3" name="email" value="<?php echo $objResult['admin_email']; ?>">
					</div>
					</div>
					...
					<div class="col-sm-8">
						<input type="text" class="form-control" id="inputEmail3" name="phoneno" value="<?php echo $objResult['admin_phone_no']; ?>">
					</div>
					</div>

					<div class="form-group">
					<label for="inputEmail3" class="col-sm-4 control-label hor-form">Address:</label>
					<div class="col-sm-8">
						<input type="text" class="form-control" id="inputEmail3" name="address" value="<?php echo $objResult['admin_address']; ?>">
					</div>
					</div>
					...
					<div class="col-sm-offset-4 col-sm-8">
						<button type="submit" class="btn btn-primary">Update</button>
											&nbsp;
											<a href="adminProfile.php" onclick="history.go(-1);" data-original-title="Edit this user" data-toggle="tooltip" type="button" class="btn btn-warning">&nbsp;Back&nbsp;</a>
					</div>
					</div>
				</form>
				</div>
