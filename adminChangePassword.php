...
<li><a href="adminChangePassword.php"><i class="fa fa-key"></i>Change Password</a></li>
			...
			<div class="grid-form1">
				...
				<div class="col-md-6">
													<input class="form-control" type="hidden" name="admin_ic" id="admin_ic" value="<?php echo($_SESSION['admin_ic']);?>" readonly>
<?php
										ini_set('display_errors', 1);
										error_reporting(~0);

										if(isset($_POST["curpassword"],$_POST["newpassword"],$_POST["confirmnewpassword"], $_POST["admin_ic"] ))
										{
											include 'config.php';

											$sessions = $_SESSION['admin_ic'];
											...
											$query1 = mysqli_query($con,"SELECT * FROM admin WHERE admin_ic = '". $_SESSION['admin_ic'] ."'");
											$result1 = mysqli_fetch_array($query1,MYSQLI_ASSOC);

											$user_password = $result1['admin_password'];
											...
											if ($newpassword==$confirmnewpassword)
											{
												...
												$query2 = mysqli_query($con,"UPDATE admin SET admin_password ='". ($newpassword) ."' WHERE admin_ic= '".$_SESSION['admin_ic']."'");
