						...
						<h2>
							...
							<span>Add Passport Details</span>
         					...
         					<div class="grid-form">
										...
										<input type="date" data-date-inline-picker="true" value="dd/mm/yyyy" class="form-control" id="passIssuedDate" name="passIssuedDate" placeholder="dd/mm/yyyy" value="<?= date('Y-m-d', time()); ?>" required>
										</div>
										
										<div class="form-group">
										<label for="lblDate">Passport Expiry Date:</label>
										<input type="date" data-date-inline-picker="true" value="dd/mm/yyyy" class="form-control" id="passExpDate" name="passExpDate" placeholder="dd/mm/yyyy" value="<?= date('Y-m-d', time()); ?>" required>
										</div>
										
										<div class="form-group">
										<label for="lblDate">Passport Taken Date:</label>
										<input type="date" data-date-inline-picker="true" value="dd/mm/yyyy" class="form-control" id="passTakenDate" name="passTakenDate" placeholder="dd/mm/yyyy" required>
										</div>
										
										<div class="form-group">
										<label for="passFile">Passport File:</label>
										<input type="file" class="form-control" name="passFile" id="passFile" accept=".pdf" placeholder="" required>
