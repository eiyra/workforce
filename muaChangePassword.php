...
<li><a href="muaChangePassword.php"><i class="fa fa-key"></i>Change Password</a></li>
    ...
    <div class="grid-form1">
      ...
      <div class="col-md-6">
                        <input class="form-control" type="hidden" name="mua_ic" id="mua_ic" value="<?php echo($_SESSION['mua_ic']);?>" readonly>
<?php
                  ini_set('display_errors', 1);
                  error_reporting(~0);

                  if(isset($_POST["curpassword"],$_POST["newpassword"],$_POST["confirmnewpassword"], $_POST["mua_ic"] ))
                  {
                    include 'config.php';
                    ...
                    $query1 = mysqli_query($con,"SELECT * FROM makeupartist WHERE mua_ic = '". $_SESSION['mua_ic'] ."'");
                    $result1 = mysqli_fetch_array($query1,MYSQLI_ASSOC);

                    $user_password = $result1['mua_password'];
                    ...
                    if ($newpassword==$confirmnewpassword)
                    {
                      ...
                      $query2 = mysqli_query($con,"UPDATE makeupartist SET mua_password ='". ($newpassword) ."' WHERE mua_ic= '".$_SESSION['mua_ic']."'");
