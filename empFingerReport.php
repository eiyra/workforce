			...
			<div id="page-wrapper" class="gray-bg dashbard-1">
				<div class="content-main">
					...
					<br>
							...
							&nbsp;&nbsp;&nbsp;<label><h6>Fingerprint Status</h6></label> &nbsp;&nbsp;
							...
							if ((isset($_POST['searchStatus'])))
							{
								...
								$query = mysqli_query($con,"SELECT * from fingerprint NATURAL JOIN fw WHERE fingerStatus='$status' ORDER BY fw_name ASC") or die(mysqli_error());
								$i = 0;
								...
								echo "<th>Fingerprint Date</th>";
								echo "<th>Fingerprint Batch</th>";
								echo "<th>Fingerprint Status</th>";
								echo "<th>Remarks</th>";
								echo "</tr>";
								echo "</thead>";
								echo "<tbody>";
						...
						if(mysqli_num_rows($query) > 0)
						{
							while($row = mysqli_fetch_assoc($query))
							{
								...
								$fingerDate = $row["fingerDate"];
								$fingerBatch = $row["fingerBatch"];
								$fingerStatus = $row["fingerStatus"];
								$fingerNote = $row["fingerNote"];
								...
								$i++;
									...
									echo "<td>" . $fingerDate . "</td>";
									echo "<td>" . $fingerBatch . "</td>";
									echo "<td>" . $fingerStatus . "</td>";
									echo "<td>" . $fingerNote . "</td>";
									echo "</tr>";
