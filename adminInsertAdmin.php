				...
				<div class="content-main">
					...
					<div class="grid-form">
						<div class="grid-form1">
							...
							<form method="post" name="formaddAdmin" action="addAdmin.php">
								<div class="form-group">
									<label for="exampleInputEmail1">Admin IC</label>
									<input name="admin_ic" id="admin_ic" class="form-control" type="text" placeholder="Example : 960203015655" pattern=".{12,}" required="required" title="Ic Number"/>
								</div>
								<div class="form-group">
									<label for="exampleInputEmail1">Admin Name</label>
									<input type="text" class="form-control" name="admin_name" id="admin_name" placeholder="Insert Admin Name" required>
								</div>
								<div class="form-group">
									<label for="exampleInputEmail1">Admin Email</label>
									<input type="email" class="form-control" name="admin_email" id="admin_email" placeholder="Insert Admin Email" required>
								</div>
								<div class="form-group">
									<label for="exampleInputEmail1">Admin Address</label>
									<input type="text" class="form-control" name="admin_address" id="admin_address" placeholder="Insert Admin Address" required>
								</div>
								<div class="form-group">
									<label for="exampleInputEmail1">Admin Gender</label>
									<div class="radio">
										<label><input type="radio" name="admin_gender" id="admin_gender" value="male">Male</label>
										<label><input type="radio" name="admin_gender" id="admin_gender" value="female">Female</label>
									</div>
								<div class="form-group">
									<label for="exampleInputEmail1">Admin Phone No</label>
									<input type="number" class="form-control" name="admin_phone_no" id="admin_phone_no" placeholder="Insert Admin PhoneNo" required>
								</div>
