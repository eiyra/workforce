		...
		<div class="grid-form1" >
			...
			<?php if($objResult['admin_image'] == null) { ?>
             <img width="200px" height="200px" src="img/default.png">
                      <?php } else { ?>
			<img src="img/<?php echo $objResult['admin_image'];?>" width="200px" height="200px" />
              <?php } ?>
			</div>
			<form method="POST" action="adminUpdateProfile.php">
			<div class="col-md-8 profile-text">
				<h6><?php echo $objResult['admin_name']; ?></h6>
				<table>

				<tr>
				<td>Email</td>
				<td> :</td>
				<td><?php echo $objResult['admin_email']; ?></td>
				</tr>

				<tr>
				<td>Contact&nbsp;Number</td>
				<td>:</td>
				<td> <?php echo $objResult['admin_phone_no']; ?></td>
				</tr>

				<tr>
				<td>Address</td>
				<td>:</td>
				<td> <?php echo $objResult['admin_address']; ?></td>
				</tr>
