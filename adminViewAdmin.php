					...
					<div class="grid-system">
						<div class="horz-grid">
							<div class="grid-hor">
								...
								?>
								<a href="adminInsertAdmin.php"><button type="button" class="btn btn-primary">+</button></a>
								<br><br>
													...
													<?php
														...
														if(mysqli_num_rows($result)>0)
														{
															while($row = mysqli_fetch_array($result,MYSQLI_ASSOC))
															{
																...
																echo 	"<td>
                                                                <a href='adminUpdateAdmin.php?admin_ic=" . $row["admin_ic"] . "' ><button type='button' class='btn btn-warning'>Update</button></a><br><br>
                                                                <a href='deleteAdmin.php?admin_ic=" . $row["admin_ic"] . "' ><button type='button' onclick='return checkDelete()' class='btn btn-danger pull-right'>Delete</button></a>
                                                                		</td>";
																echo "</tr>";
															}
														}
