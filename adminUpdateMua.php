...
<li><a href="adminChangePassword.php"><i class="fa fa-key"></i>Change Password</a></li>
			...
			<div id="page-wrapper" class="gray-bg dashbard-1">
				<div class="content-main">
					...
					<div class="banner">
						<h2>
							...
							<span>Update Makeup Artist</span>
						</h2>
					</div>

					<div class="grid-form">
										<form method="post" name="FormUpdateMua" id="FormUpdateMua" action="updateMua.php">
										 <!-- <div class="grid-form1"> -->
															...
															<input type="hidden" class="form-control" id="inputName" name="ic" value="<?php echo $objResult1['mua_ic']; ?>" readonly>


														<div class="form-group">
													<label for="inputName" class="col-sm-2 control-label hor-form">Name:</label>
											<div class="col-sm-10">
											<input type="text" class="form-control" id="inputName" name="name" value="<?php echo $objResult1['mua_name']; ?>">
											</div>
										</div>
								...
								<div class="col-sm-10">
								<input type="text" class="form-control" id="inputName" name="email" value="<?php echo $objResult1['mua_email']; ?>">
								</div>
							</div>
					...
					<div class="col-sm-10">
					<input type="text"  class="location form-control" id="location" name="location" value="<?php echo $objResult1['mua_address']; ?>">
					</div>
				...
				<div class="col-sm-10">
				<input type="text" class="form-control" id="inputName" name="gender" value="<?php echo $objResult1['mua_gender']; ?>"readonly>
				</div>
				</div>
		...
		<div class="col-sm-10">
		<input type="number" class="form-control" id="inputName" name="phoneno" value="<?php echo $objResult1['mua_phone_no']; ?>">
		</div>
	</div>

	<div class="form-group">
<label for="inputName" class="col-sm-2 control-label hor-form">Service Charge (RM):</label>
<div class="col-sm-10">
<input type="number" class="form-control" id="inputName" name="charge" value="<?php echo $objResult1['mua_charge']; ?>">
</div>
</div>
