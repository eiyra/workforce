						...
						<?php
							if ((isset($_POST['searchYear'])))
							{
								if($_POST['Year'])
								{
									...
									$result9 = mysqli_query($con,$query9) or die(mysql_error());
									...
									$result10 = mysqli_query($con,$query10) or die(mysql_error());
									...
									$result11 = mysqli_query($con,$query11) or die(mysql_error());
									...
									$result12 = mysqli_query($con,$query12) or die(mysql_error());
